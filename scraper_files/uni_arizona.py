...
def get_name(prof):
    name = prof.find('span', class_="field field--name-title field--type-string field--label-hidden").text.strip()
    return name

def get_link(prof):
    link = "https://www.cs.arizona.edu" + prof.find('a')['href']
    return link
...
def uni_arizona():
    urls = ["https://www.cs.arizona.edu/about/faculty"]
    ...
    all_profs = soup.find_all('div', class_="az-person-row")
