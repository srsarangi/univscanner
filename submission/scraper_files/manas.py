...
def manas_faculty():
    ...
    base_url = "https://www.manas.edu.kg"
    faculty_directory_url = f"{base_url}/en/engineering/computer_engineering/staff"
    driver.get(faculty_directory_url)
    driver.implicitly_wait(10)

    # Parse the main faculty directory page to extract faculty sections
    soup = BeautifulSoup(driver.page_source, "html.parser")
    faculty_sections = soup.select('.uni-managers-item')

    # File setup for output
    # txt_filename = "manas_faculty.txt"
    # csv_filename = "manas_faculty.csv"
    ...
    keyword_list = [
        ...
        'cryptography', 'block ciphers', 'hash functions', 'information security'
    ]
    ...
    for section in faculty_sections:
        try:
            ...
            name_tag = profile_soup.find("h5", class_="font-weight-bold")
            ...
            research_tag = profile_soup.find("div", class_="offset-top-20")
            ...
            if any(re.search(keyword, research_text, re.IGNORECASE) for keyword in keyword_list):
                ...
                profs.append([university, country, name, email, profile_url])
    ...
    print("manas faculty data extraction complete")
    return profs
