...
# JUST TEMPLATE
def czech():
    url = "https://www.tf.czu.cz/en/r-9400-about-faculty/r-9462-academic-senate"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Czech University of Life Sciences in Prague.csv"
        ...
        univ_name = "Czech University of Life Sciences in Prague"
