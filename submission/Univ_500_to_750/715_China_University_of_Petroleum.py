...
def cuop(url):
    ...
    if response.status_code == 200:
        ...
        csv_filename = "China University of Petroleum.csv"
        ...
        univ_name = "China University of Petroleum"
        country = "China"
        ...
        d = soup.find_all('div', {'class': 'c-guanwang-en-msg-list-module__down-detail-container'})
        for i in d:
            div = i.find('div', {'class': 'c-guanwang-en-msg-list-module__down-detail-title'})
            if div == None:
                continue
            ...
            if a == None:
                continue
            link = "https://www.cupk.edu.cn" +a.get('href')
            print(name,link)
            try:
...
if __name__ == '__main__':
    ...
    main_url1 = "https://www.cupk.edu.cn/webEnglish/facultystaff/school-of-engineering/professor/index_"
    suffix = ".shtml"
    i = 2
    while True:
        if not cuop(main_url1 + str(i) + suffix):
            break
        else:
            i += 1

    cuop("https://www.cupk.edu.cn/webEnglish/facultystaff/school-of-engineering/professor/")

    main_url2 = "https://www.cupk.edu.cn/webEnglish/facultystaff/school-of-engineering/associate-professor/index_"
    i =2
    while True:
        if not cuop(main_url2 + str(i) + suffix):
            break
        else:
            i += 1
    
    cuop("https://www.cupk.edu.cn/webEnglish/facultystaff/school-of-engineering/associate-professor/")
