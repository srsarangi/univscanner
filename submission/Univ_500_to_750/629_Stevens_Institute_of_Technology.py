...
def stevens():
    ...
    if response.status_code == 200:
        ...
        csv_filename = "Stevens Institute of Technology.csv"
        ...
        univ_name = "Stevens Institute of Technology"
        ...
        d = soup.find_all('div', {'class': 'faculty-card_name-title__By2JH'})
        for i in d:
            a = i.find('a')
            if a == None:
                continue
            link = "https://www.stevens.edu"+ a.get('href')
            name = a.get_text()
            print(name, link)
            email = "Not Found"
            # return
