...
def unimore(url):
    ...
    if response.status_code == 200:
        ...
        csv_filename = "University of Modena and Reggio Emilia.csv"
        ...
        univ_name = "University of Modena and Reggio Emilia"
        country = "Italy"
...
if __name__ == '__main__':
    url1 = "https://www.fim.unimore.it/en/department/staff/department-staff/full-professors"
    url2 = "https://www.fim.unimore.it/en/department/staff/department-staff/associate-professors"
    url3 = "https://www.fim.unimore.it/en/department/staff/department-staff/assistent-professors-rtu"
    url4 = "https://www.fim.unimore.it/en/department/staff/department-staff/assistent-professors-rtd-rtt"
    unimore(url1)
    unimore(url2)
    unimore(url3)
    unimore(url4)
