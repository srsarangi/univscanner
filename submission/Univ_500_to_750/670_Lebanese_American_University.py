...
def lau():
    url = "https://soas.lau.edu.lb/academics/departments/computer-science-maths/faculty-staff.php"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Lebanese American University.csv"
        ...
        univ_name = "Lebanese American University"
        country = "Lebanon"
