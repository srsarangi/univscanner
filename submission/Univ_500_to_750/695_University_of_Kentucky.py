...
def kentucky(url):
    ...
    if response.status_code == 200:
        ...
        csv_filename = "University of Kentucky.csv"
...
if __name__ == '__main__':
    url1 = "https://engr.uky.edu/people?category=All&field_department_target_id=30"
    url2 = "https://engr.uky.edu/people?category=All&field_department_target_id=32"
    url3 = "https://engr.uky.edu/people?category=All&field_department_target_id=41"
    kentucky(url1)
    kentucky(url2)
    kentucky(url3)
