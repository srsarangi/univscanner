...
# JUST TEMPLATE
def ibero():
    url = "https://ibero.mx/licenciaturas/licenciatura-en-ingenier-de-tecnolog-de-c-mputo-y-telecomunicaciones"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Universidad Iberoamericana IBERO.csv"
        ...
        univ_name = "Universidad Iberoamericana IBERO"
        country = "Mexico"
