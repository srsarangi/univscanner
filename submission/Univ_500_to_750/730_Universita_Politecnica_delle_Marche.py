...
# JUST TEMPLATE
def updm():
    url = "https://www.univpm.it/Entra/Professors/Engineering_1"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Universita Politecnica delle Marche.csv"
        ...
        univ_name = "Universita Politecnica delle Marche"
        country = "Italy"
