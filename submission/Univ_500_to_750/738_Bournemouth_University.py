...
def bournemouth():
    return 
    url = "https://www.bournemouth.ac.uk/about/our-faculties/faculty-science-technology/our-departments/department-computing-informatics/department-computing-informatics-staff"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Bournemouth University.csv"
        ...
        univ_name = "Bournemouth University"
        ...
        d = soup.find('section', {'id': 'block-slices-slice-body'})
