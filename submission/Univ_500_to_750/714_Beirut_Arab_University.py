...
def beirut():
    url = "https://www.bau.edu.lb/Staff/Science/Academic"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Beirut Arab University.csv"
        ...
        univ_name = "Beirut Arab University"
        country = "Lebanon"
        ...
        profs = soup.find_all('div',{'class':'col-lg-2 col-md-3 col-6 g-mb-30 u-shadow-v20'})
        ...
        for prof in profs:
            ...
            link = "https://www.bau.edu.lb"+ a.get('href')
            h5 = prof.find('h5')
            if h5 == None:
                continue
