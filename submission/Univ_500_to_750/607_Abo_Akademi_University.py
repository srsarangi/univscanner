...
def abo():
    url = "https://www.abo.fi/en/information-technology-research-and-researchers-2-2-2/"
    response = requests.get(url)
    if response.status_code == 200:

        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Abo Akademi University.csv"
        ...
        univ_name = "Abo Akademi University"
        country = "Finland"
        ...
        d = soup.find('div', {'class': 'page-content'})
        if d == None:
