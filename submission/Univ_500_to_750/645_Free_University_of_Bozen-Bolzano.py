...
def bozen():
    url = "https://www.unibz.it/en/faculties/engineering/academic-staff/"
    response = requests.get(url)
    if response.status_code == 200:

        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Free University of Bozen-Bolzano.csv"
