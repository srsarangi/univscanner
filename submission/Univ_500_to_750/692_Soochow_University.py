...
def soochow():
    url = "https://eng.suda.edu.cn/Academics/Schools/201712/63e15046-41db-4a09-baf2-a5a18d7e6bbe.html"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Soochow University.csv"
