...
def iitbh(url):
    ...
    if response.status_code == 200:
        ...
        csv_filename = "Indian Institute of Technology Bhubaneswar.csv"
        ...
        univ_name = "Indian Institute of Technology Bhubaneswar"
        country = "India"
        ...
        d = soup.find_all('h2', {'class': 'entry-title ast-blog-single-element'})
        ...
        for i in d:
            ...
            link = a.get('href')
            link = link.replace("https://www.iitbbs.ac.in/","https://secs.iitbbs.ac.in/")
            email = "Not Found"
            print(name, link)
            try:
...
if __name__ == '__main__':
    url = "https://www.iitbbs.ac.in/index.php/category/faculty-members/school-of-electrical-sciences-faculty-members/cse/page/"
    # iitbh()
    for i in range(1,3):
        iitbh(url+str(i)+"/")
        # time.sleep(2)
