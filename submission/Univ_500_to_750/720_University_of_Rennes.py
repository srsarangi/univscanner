...
# JUST TEMPLATE
def rennes():
    url = "https://istic.univ-rennes.fr/interlocuteurs?f%5B0%5D=interlocutor_category%3A195&f%5B1%5D=interlocutor_category%3A196&f%5B2%5D=interlocutor_category%3A197&f%5B3%5D=interlocutor_category%3A199&f%5B4%5D=interlocutor_category%3A20"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "University of Rennes.csv"
        ...
        univ_name = "University of Rennes"
        country = "France"
