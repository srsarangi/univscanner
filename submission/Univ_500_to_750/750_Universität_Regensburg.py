...
def f():
    url = "https://www.uni-regensburg.de/informatics-data-science/faculty/the-faculty/faculty-structure/department-information-systems/index.html"
    response = requests.get(url)
    if response.status_code == 200:
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Universität Regensburg.csv"
        ...
        univ_name = "Universität Regensburg"
        country = "Germany"
