...
# JUST TEMPLATE
def pucdv():
    url = "https://www.pucv.cl/uuaa/faculty-of-engineering/academic-units/school-of-computer-engineering"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Pontificia Universidad Católica de Valparaíso.csv"
        ...
        univ_name = "Pontificia Universidad Católica de Valparaíso"
        country = "Chile"
