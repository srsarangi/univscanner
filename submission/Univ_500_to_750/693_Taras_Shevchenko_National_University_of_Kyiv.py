...
# JUST TEMPLATE
def taras():
    url = "https://csc.knu.ua/en/department/cm"
    return 
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Taras Shevchenko National University of Kyiv.csv"
        ...
        univ_name = "Taras Shevchenko National University of Kyiv"
        country = "Ukraine"
