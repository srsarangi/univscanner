...
def aberystwyth():
    url = "https://www.aber.ac.uk/en/cs/staff-profiles/listing/az/"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Aberystwyth University.csv"
        ...
        univ_name = "Aberystwyth University"
        ...
        table = soup.find('table',{'id':'sp_listing'})
        ...
        for prof in profs:
            ...
            if len(td) >= 5:
                ...
                if a == None:
                    continue
                link ="https://www.aber.ac.uk/en/cs/staff-profiles/listing/"+ a.get('href').strip('../')
