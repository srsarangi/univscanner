...
def salle():
    url = "https://www.dlsu.edu.ph/colleges/ccs/faculty-profile/"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "De La Salle University.csv"
        ...
        univ_name = "De La Salle University"
        country = "Philippines"
        ...
        d = soup.find_all('div',{'class':'wpb_text_column wpb_content_element'})
