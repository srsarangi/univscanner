...
def virgili():
    url = "https://www.urv.cat/en/studies/master/courses/computer-security-engineering/all-professors/"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Universitat Rovira i Virgili.csv"
