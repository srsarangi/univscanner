...
def usek():
    url = "https://www.usek.edu.lb/en/teaching-personnel/list-of-full-time-faculty-members"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Holy Spirit University of Kaslik .csv"
        ...
        univ_name = "Holy Spirit University of Kaslik "
        country = "Lebanon"
