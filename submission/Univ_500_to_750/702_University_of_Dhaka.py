...
def dhaka():
    url = "https://www.du.ac.bd/body/FacultyMembers/CSE"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "University of Dhaka.csv"
        ...
        d = soup.find_all('div', {'class': 'col-md-4 col-sm-6 single-item'})
        d1 = soup.find('div', {'class': 'col-md-4 col-lg-offset-4 single-item'})
        d.append(d1)
