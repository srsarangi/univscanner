...
def coventry():
    url = "https://www.coventry.ac.uk/life-on-campus/staff-directory/?filters=1187"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable

        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Coventry University.csv"
