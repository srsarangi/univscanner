...
def iium(url):
    ...
    if response.status_code == 200:
        ...
        csv_filename = "International Islamic University Malaysia (IIUM).csv"
        ...
        univ_name = "International Islamic University Malaysia (IIUM)"
        country = "Malaysia"
        ...
        profs = soup.find_all('div',{'style':'padding-bottom:15px'})
        if len(profs) == 0: 
...
if __name__ == '__main__':
    # iium()
    main_url = "https://www.iium.edu.my/directory/?letter=&name=&expertise=&kcdiom=239&type=&sort=01&page="
    i = 0
    while True:
        print("Page: ", i)
        if not iium(main_url+str(i)):
            break
        else:
            i += 1
            # print("Page: ", i)
