...
# JUST TEMPLATE
def ufdmg():
    url = "https://homepages.dcc.ufmg.br/~leob/site/dcc-cs-department/"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Universidade Federal de Minas Gerais.csv"
        ...
        univ_name = "Universidade Federal de Minas Gerais"
        country = "Brazil"
