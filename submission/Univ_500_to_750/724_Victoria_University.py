...
def victoria(url):
    ...
    if response.status_code == 200:
        ...
        csv_filename = "Victoria University .csv"
        ...
        for prof in tr:
            ...
            link = "https://www.uvic.ca/ecs/computerscience/people/faculty/"+ a.get('href')
            email = "Not Found"
            print(name,link)
            try:
...
if __name__ == '__main__':
    # victoria()
    url1 = "https://www.uvic.ca/ecs/computerscience/people/faculty/index.php"
    victoria(url1)
