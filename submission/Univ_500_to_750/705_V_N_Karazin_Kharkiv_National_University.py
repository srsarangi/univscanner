...
# JUST TEMPLATE
def f():
    url = "https://karazin.ua/en/fakulteti-ta-instituti/komp-iuternikh-nauk/"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "V_N_Karazin Kharkiv National University.csv"
        ...
        univ_name = "V_N_Karazin Kharkiv National University"
        country = "Ukraine"
