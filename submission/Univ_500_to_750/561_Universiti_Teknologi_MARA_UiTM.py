...
# TEMPLATE
def uitm():
    url = "https://kelantan.uitm.edu.my/index.php/en/academic/dir-faculty-of-computer-mathematical-sciences?start=20"
    ...
    if response.status_code == 200:
        ...
        csv_filename = "Universiti Teknologi MARA - UiTM.csv"
        ...
        univ_name = "Universiti Teknologi MARA - UiTM"
        country = "Malaysia"
