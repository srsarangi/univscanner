...
def ecust():
    url = "https://cise.ecust.edu.cn/2011/0615/c7766a55144/page.htm"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "East China University of Science and Technology.csv"
        ...
        univ_name = "East China University of Science and Technology"
        country = "China"
