...
def perugia():
    # url = "https://www.unipg.it/en/university/departments?view=navigatorestrutture&struttura=516900"
    url = "https://www.unipg.it/en/university/departments?view=navigatorestrutture&struttura=516900"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Università degli Studi di Perugia.csv"
        ...
        univ_name = "Università degli Studi di Perugia"
        country = "Italy"
