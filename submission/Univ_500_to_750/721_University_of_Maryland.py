...
def maryland(url):
    ...
    if response.status_code == 200:
        ...
        csv_filename = "University of Maryland, Baltimore County.csv"
        ...
        univ_name = "University of Maryland, Baltimore County"
        ...
        profs = soup.find_all('div',{'class':'mceEditable'})
        for prof in profs:
            a = prof.find('a')
            if a == None:
                continue
...
def get_email(variables,garbage_emails,name,link,email,page_resp):
    ...
    key_words = ['operating systems','Embedded System','embedded system', 'Operating Systems','operating system','Operating System','embedded systems',"Embedded Systems",'kernel','Microcontroller Systems','Integrated Systems','Embedded Computing','Embedded Software','linux']
...
if __name__ == '__main__':
    # maryland()
    url1 ="https://www.csee.umbc.edu/tenure-track-faculty/"
    url2 ="https://www.csee.umbc.edu/instructional-faculty/"
