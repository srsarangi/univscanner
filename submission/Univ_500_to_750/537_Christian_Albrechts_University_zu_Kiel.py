...
# # Access the page (cookies will be managed automatically)
# response = session.get("https://example.com")

# print(response.text)
def kiel():
    url = "https://www.inf.uni-kiel.de/en/about-us/history/heads-of-the-department-of-computer-science"
    session = requests.Session()
    ...
    if response.status_code == 200:
        ...
        csv_filename = "Christian-Albrechts-University zu Kiel.csv"
        ...
        univ_name = "Christian-Albrechts-University zu Kiel"
        country = "Germany"
        ...
        for i in dd:
            ...
            email = "Not Found"
            link = url
            remaining = " ".join(text[1:])
            print(name)
            for word in key_words:
                if re.search(word,remaining,re.IGNORECASE):
