...
def zhengzhou():
    ...
    if response.status_code == 200:
        ...
        csv_filename = "Zhengzhou University.csv"
        ...
        univ_name = "Zhengzhou University"
...
def get_email(variables,garbage_emails,name,link,email,page_resp):
    ...
    key_words = ['operating systems','Embedded System','embedded system', 'Operating Systems','operating system','Operating System','embedded systems',"Embedded Systems",'kernel','Microcontroller Systems','Integrated Systems','Embedded Computing']
