...
# JUST TEMPLATE
def njunju():
    url = "https://cs.nju.edu.cn/2640/list.htm"
    return 
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Nanjing University of Science and Technology.csv"
        ...
        univ_name = "Nanjing University of Science and Technology"
