...
def windsor():
    url = "https://www.uwindsor.ca/science/computerscience/1046/faculty"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "University of Windsor.csv"
        ...
        univ_name = "University of Windsor"
        country = "Canada"
        ...
        profs = soup.find_all('a',{'class':'btn btn-lg btn-block'})
        for prof in profs:
            name = prof.get_text().strip()
            link = "https://www.uwindsor.ca"+ prof.get('href')
            print(name, link)
            try:
