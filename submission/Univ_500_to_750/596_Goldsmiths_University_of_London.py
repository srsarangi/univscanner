...
def goldul():
    url = "https://www.gold.ac.uk/computing/people/"
    response = requests.get(url)
    if response.status_code == 200:

        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Goldsmiths, University of London.csv"
        ...
        for i in dd:
            ...
            if a == None:
                # print('a')
                continue
            link = "https://www.gold.ac.uk"+a.get('href')
...
if __name__ == '__main__':
    # url1 = "https://www.gold.ac.uk/computing/people/"
    # url2 ="https://www.gold.ac.uk/computing/people/professional-staff/"
    goldul()
