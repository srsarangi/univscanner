...
def scu():
    url = "https://www.scu.edu.au/science-and-engineering/our-people/"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Southern Cross University .csv"
