...
# JUST TEMPLATE
def westminster():
    url = "https://www.westminster.ac.uk/research/groups-and-centres/software-systems-engineering-research-group#staff_profile_manual_listing"
    return
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "University of Westminster.csv"
        ...
        univ_name = "University of Westminster"
