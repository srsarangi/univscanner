...
def tokyo():
    url = "https://www.tus.ac.jp/en/fac/ko1/inf.html"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Tokyo University of Science.csv"
        ...
        univ_name = "Tokyo University of Science"
        country = "Japan"
        ...
        table = soup.find('table', {'class': 'table-faculty'})
        ...
        for i in trs:
            ...
            if len(td) == 4:
                ...
                if a == None:
                    continue
                link = "https://www.tus.ac.jp" +a.get('href')
