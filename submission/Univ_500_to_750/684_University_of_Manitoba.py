...
def manitoba():
    url = "https://umanitoba.ca/science/directory/computer-science"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "University of Manitoba.csv"
