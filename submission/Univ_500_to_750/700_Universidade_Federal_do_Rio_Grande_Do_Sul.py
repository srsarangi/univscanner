...
def ufdrgds():
    url = "https://www.inf.ufrgs.br/site/en/people/faculty/"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "Universidade Federal do Rio Grande Do Sul.csv"
        ...
        univ_name = "Universidade Federal do Rio Grande Do Sul"
        country = "Brazil"
