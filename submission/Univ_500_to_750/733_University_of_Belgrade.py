...
def belgrade():
    url = "https://www.etf.bg.ac.rs/en/departments/the-department-of-computer-science-and-information-technology"
    response = requests.get(url)
    if response.status_code == 200:
        # scrappable
        soup = BeautifulSoup(response.text, "html.parser")
        csv_filename = "University of Belgrade.csv"
        ...
        univ_name = "University of Belgrade"
        country = "Serbia"
        ...
        d = soup.find('div', {'class': 'strana-body'})
        a = d.find_all('a')
        for i in a:
            link = "https://www.etf.bg.ac.rs"+ i.get('href')
