...
def heriot_watt():
    ...
    url = "https://www.hw.ac.uk/uk/schools/mathematical-computer-sciences/macs-staff/computer-science.htm"   # homepage url
    ...
    filename = "heriot_watt.txt"
    f = open(filename, "w")

    excel_filename = "heriot_watt.csv"
   ...
   ## print(soup)
    # d gives the array of all profs on the dept homepageJn
    d = soup.find("div",{"class":"col-md-7 col-sm-12"})
    dd = d.find_all("tr",{"class":"clickable"})
   # dd =d.  ('table') 
   # ddd = dd.findAll("td")
    print(soup)
    # count = 0 
    ...
    for i in d:
        ##print(a)                    # a contains the name and the homepage of prof
        a = i.find('a')
