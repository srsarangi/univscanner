...
def oxford():
    url = "https://www.utas.edu.au/built-digital-natural/people/information-and-communication-technology?queries_classification_query=Academic"   # homepage url
    ...
    d = soup.find('table', {'class':'table'})
    dd = d.find_all('tr')

    #iterating for every prof
    for i in dd:
        
        a = i.find('a',{'class':"profile-link"})  
        if type(a)!=int and a!=None:                   # a contains the name and the homepage of prof
