...
def oxford():
    ...
    f.write("not available" + '\n' + "dr Marcin Engel" + "\t"+ " M.Engel@mimuw.edu.pl" + "\n")
    csvwriter.writerow([u_name, country,"dr Marcin Engel"," M.Engel@mimuw.edu.pl","not available"])
    csvwriter2.writerow([u_name, country, "dr Marcin Engel"," M.Engel@mimuw.edu.pl","not available"])
    f.write(" http://www.mimuw.edu.pl/~marpe/" + '\n' + " Marcin Peczarski" + "\t"+ " M.Peczarski@mimuw.edu.pl" + "\n")
    csvwriter.writerow([u_name, country," Marcin Peczarski"," M.Peczarski@mimuw.edu.pl"," http://www.mimuw.edu.pl/~marpe/"])
    csvwriter2.writerow([u_name, country, " Marcin Peczarski","M.Peczarski@mimuw.edu.pl"," http://www.mimuw.edu.pl/~marpe/"])
    f.write(" http://www.mimuw.edu.pl/~marpe/" + '\n' + " Marcin Peczarski" + "\t"+ " M.Peczarski@mimuw.edu.pl" + "\n")
    csvwriter.writerow([u_name, country," Marcin Peczarski"," M.Peczarski@mimuw.edu.pl"," http://www.mimuw.edu.pl/~marpe/"])
    csvwriter2.writerow([u_name, country, " Marcin Peczarski","M.Peczarski@mimuw.edu.pl"," http://www.mimuw.edu.pl/~marpe/"])
