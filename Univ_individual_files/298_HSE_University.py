...
def oxford():
    url = "https://cs.hse.ru/en/persons/"  # homepage url
    ...
    d = soup.find_all('div', {'class':'fa-card__content'})
    temp = d[4]
    dd = temp.find_all('div', {'class': 'fa-person__box'})
    #print(d)
    #iterating for every prof
    for i in dd:
        a = i.find('a')                     # a contains the name and the homepage of prof
        link ="https:"+ a.get('href') +"#teaching"               # extracting prof page link
