...
def oxford():
    url = "https://engineering.buffalo.edu/computer-science-engineering/people/faculty-directory.html"   # homepage url
    ...
    filename = "buffalo.txt"
    f = open(filename, "w")

    excel_filename = "buffalo.csv"
    ...
    u_name = "University at Buffalo SUNY"
    country = "Us"
    ...
    d = soup.find('ul', {'class':'list-style-teaser'})
    dd = d.find_all('div', {'class': 'profileinfo-teaser-name'})

    #iterating for every prof
    for i in d:
        a = i.find('a')                     # a contains the name and the homepage of prof
        link = "https://engineering.buffalo.edu"+ a.get('href')                # extracting prof page link
