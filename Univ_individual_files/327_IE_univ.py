...
def IE_univ():
    url = "https://static-frm.ie.edu/university/university/about/faculty/search/information-systems-technology/#orientation"   # homepage url
    ...
    filename = "IE_UNIV.txt"
    f = open(filename, "w")

    excel_filename = "IE_UNIV.csv"
    ...
    d = soup.find('div', {'class':'module_content'})
    dd = d.find_all('div', {'class': 'module-faculty_teacher'})
    #print(dd)
