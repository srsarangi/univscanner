...
def qaboos():
    url = "https://www.squ.edu.om/science/Departments/Computer-Science/Department-People/Faculty"   # homepage url
    ...
    dd = soup.find_all('tr', {'class' : 'dnnGridItem'})
    
    #iterating for every prof
    for i in dd:
        if i.find('h2') == None:
            continue        
        a = i.find('h2')                     # a contains the name and the homepage of prof
        print(a)
        link = "Personal Webpage Not found"               # extracting prof page link
