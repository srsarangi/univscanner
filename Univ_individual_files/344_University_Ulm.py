...
def oxford():
    url = "https://www.uni-ulm.de/en/in/fakultaet/fakultaet/fakultaet-organisation/ "   # homepage url
    ...
    d = soup.find_all('div', {'class':'container'})
    dd = d[6]
    ddd = dd.find_all('a')

    #iterating for every prof
    for i in ddd:
        a = i                   # a contains the name and the homepage of prof
        link = "https://www.uni-ulm.de" + a.get('href')                # extracting prof page link
    ...
    f.write('No computer architecture Professor')
    csvwriter.writerow([u_name, country, 'No computer architecture Professor'])
    csvwriter2.writerow([u_name, country, 'No computer architecture Professor'])
