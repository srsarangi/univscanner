...
def Aalborg_University():
    url = "https://vbn.aau.dk/en/organisations/institut-for-datalogi/persons/"   # homepage url
    ...
    filename = "Aalborg_University.txt"
    f = open(filename, "w")

    excel_filename = "Aalborg University.csv"
    ...
    d = soup.find_all('h3',{'class': "title"})
   # print(d)
    #dd = d.find_all()
    ...
    for i in d:
        ...
        link = "https://vbn.aau.dk"+ a.get('href')                # extracting prof page link
    ...
    f.write("http://people.cs.aau.dk/~adavid/" + '\n' + "Alexandra David"  + "\t"+"cannot be found" + "\n")
    csvwriter.writerow([u_name, country, "Alexandra David" , email,"http://people.cs.aau.dk/~adavid/"])
    csvwriter2.writerow([u_name, country, "Alexandra David" , email,"http://people.cs.aau.dk/~adavid/"])
