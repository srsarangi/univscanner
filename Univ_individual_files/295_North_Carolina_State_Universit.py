...
def oxford():
    url = "https://www.csc.ncsu.edu/directories/faculty.php"   # homepage url
    ...
    filename = "North_Carolina_State_Universit.txt"
    f = open(filename, "w")

    excel_filename = "North_Carolina_State_Universit.csv"
    ...
    u_name = "North Carolina State Universit"
    ...
    d = soup.find('div', {'class':'people_container'})
    dd = d.find_all('div', {'class': 'person'})

    #iterating for every prof
    for i in dd:
        a = i.find('a')                     # a contains the name and the homepage of prof
        link = "https://www.csc.ncsu.edu/"+a.get('href')                # extracting prof page link
