...
def oxford():
    url = "https://www.minet.uni-jena.de/fakultaet/l_erhard.html"   # homepage url
    ...
    link =   "https://www.minet.uni-jena.de/fakultaet/l_erhard.html"         
        # extracting prof page link
    name = d.find('dd').get_text() 
    name = name[:24]                # extracting prof name
    ...
    #print(name)
    email = "werner.erhard@uni-jena.de"
    print(name, link)
    f.write(link + '\n' + name + "\t"+ email + "\n")
