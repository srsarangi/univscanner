...
def Umea_Univ():
    url = "https://www.umu.se/en/department-of-computing-science/staff_at_the_department_of_computing_science/"   # homepage url
    ...
    d = soup.find('div', {'class':'personallista'})
