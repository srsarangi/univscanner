...
def waikato():
    url = "https://www.waikato.ac.nz/staff-profiles/a-z"   # homepage url
    ...
    filename = "waikato.txt"
    f = open(filename, "w")

    excel_filename = "waikato.csv"
    ...
    d = soup.find('section', {'class': 'standard col-md-7'})
    d1 = d.find_all('p')
    dd = []
    for i in d1:
        d2 = i.find_all('a')
    ...
    for i in dd:
        a = i
        link = "https://www.waikato.ac.nz/staff-profiles/"+ a.get('href')                # extracting prof page link
