...
def oxford():
    url = "https://faculty.sustech.edu.cn/?field=Department%20of%20Computer%20Science%20and%20Engineering&lang=en"   # homepage url
    ...
    filename = "Southern_university.txt"
    f = open(filename, "w")

    excel_filename = "Southern_university.csv"
    ...
    d = soup.find('div', {'class':'teacher_wrap inx_div'})
    dd = d.find_all('li')
    ...
    for i in dd:
        ...
        if type(a)!=int:                  # a contains the name and the homepage of prof
            link ='https://faculty.sustech.edu.cn'+a.get('href')                # extracting prof page link
