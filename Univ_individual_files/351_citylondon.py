...
def citylondonuni():
    url = "https://www.city.ac.uk/about/schools/mathematics-computer-science-engineering/computer-science#tabs561080-link580290/"
    ...
    filename = "citylondonuni.txt"
    f = open(filename, "w", encoding='utf-8')

    excel_filename = "citylondonuni.csv"
    ...
    u_name = "City, London of University"
    country = "United Kingdom"
    garbage_emails = ['contact@massey.ac.nz']
    var = [f, csvwriter, csvwriter2, u_name, country]

    #print(soup)
    d = soup.find('div',{'class':'department__staff department__staff--academic'})
    d = d.find_all('a')
    #print(d)
    #d = d.find_all('a')
    #print(len(d))
