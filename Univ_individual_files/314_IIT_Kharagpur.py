...
def IIT_KHARAGPUR():
    url = "https://cse.iitkgp.ac.in/oldlook/faculty.html"   # homepage url
    ...
    filename = "IIT_KHARAGPUR.txt"
    f = open(filename, "w")

    excel_filename = "IIT_KHARAGPUR.csv"
   ...
   # d = soup.find('TABLE')
    ...
    for i in dd:
       # print(i)   
        a = i.find('a') 
        name = i.find('b').get_text()
        
        link =  a.find_next('a').find_next('a').find_next('a').get('href')                # extracting prof page link
