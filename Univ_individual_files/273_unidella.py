...
def unidella():
    url = "https://search.usi.ch/en/faculties/3/facolta-di-scienze-informatiche/people?_gl=1*vjxjtu*_ga*MTU3ODk0NTkxOC4xNjM0NDYwNDUx*_ga_89Y0EEKVWP*MTYzNDQ2MDQ1MS4xLjEuMTYzNDQ2MjE2My4zNQ..&_ga=2.16212086.1184706243.1634460451-1578945918.1634460451"
    ...
    filename = "unidella.txt"
    f = open(filename, "w", encoding='utf-8')

    excel_filename = "unidella.csv"
    ...
    for i in a:
        ...
        if link == None :
            continue
        link = p[0].get('href')                              # extracting prof page link
        name=name.strip()
