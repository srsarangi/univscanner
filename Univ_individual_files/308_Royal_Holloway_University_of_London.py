...
def Royal_Holloway_University_of_London():
    url = "https://pure.royalholloway.ac.uk/portal/en/organisations/department-of-computer-science(23783e79-7f79-4a1f-9eb7-59deb4eb7152)/persons.html?filter=current"   # homepage url
    ...
    filename = "Royal_Holloway_University_of_London.txt"
    f = open(filename, "w")

    excel_filename = "Royal_Holloway_University_of_London.csv"
    ...
    u_name = "Royal_Holloway_University_of_London"
    ...
    d = soup.find_all('h2', {'class':"title"})
    # count = 0 
...
if __name__ == '__main__':
    Royal_Holloway_University_of_London()
