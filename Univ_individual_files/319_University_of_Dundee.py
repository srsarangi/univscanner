...
def Bandung_Institute_of_Technology():
    url = "https://www.dundee.ac.uk/computing/people"   # homepage url
    ...
    d = soup.find('div', {'class':'search-results__listings'})
    dd = d.find_all('div', {'class': 'card__text card__text--image'})
    print(dd)
    #iterating for every prof
    for i in dd:
        a = i.find('a')                     # a contains the name and the homepage of prof
        link = "https://www.dundee.ac.uk"+a.get('href')                # extracting prof page link
...
def filterandgetEmail(var, garbage_emails, name, link, email, prof_resp):
    ...
    keyword_list = ['Computer architecture','computer architecture','Computer Architecture', 'Hardware And System Architecture', 'hardware and system architecture', 
                ...
                'Distributed System', 'distributed system', 'Distributed system','Architecture and Operating Systems' ]
    flag = 1
...
if __name__ == '__main__':
   Bandung_Institute_of_Technology()