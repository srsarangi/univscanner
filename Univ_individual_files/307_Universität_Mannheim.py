...
def oxford():
    url = "https://www.wim.uni-mannheim.de/en/about/chairs-and-professors/"   # homepage url
    ...
    filename = "mannheim.txt"
    f = open(filename, "w")

    excel_filename = "mannheim.csv"
    ...
    d = soup.find('div', {'class':'uma-address-tile callout'})
    dd = d.find_all('div', {'class': 'column small-8 medium-4'})
