...
def uchicago():
    url = "https://engineering.purdue.edu/ECE/People/Faculty"   # homepage url
    ...
    u_name = "University of Purdue"
    country = "USA"

    garbage_emails = ['webmaster-ece@ecn.purdue.edu']
    var = [f, csvwriter, csvwriter2, u_name, country]

    # d gives the array of all profs on the dept homepage
    d = soup.find_all('div', {'class':'col col-xs-12 col-md-7 list-name'})
...
def filterandgetEmail(var, garbage_emails, name, link, email, prof_resp):
    ...
    keyword_list = ['Computer architecture','computer architecture','Computer Architecture', 'Hardware And System Architecture', 'hardware and system architecture', 'Hardware and software architecture'
