...
def Uthah_univ():
    url = "https://www.cs.utah.edu/people/faculty/"   # homepage url
    ...
    d = soup.find("tbody")
    d1 = d.find_next("tbody")
    dd = d1.find_all("table", {"id": "info"})
   # print(dd)
    ...
    for i in dd:
        ...
        name = a.get_text()  
        name = name.strip()               # extracting prof name
