...
def Politecnico_di_Torino():
    url = "https://www.dauin.polito.it/personale/elenco"   # homepage url
    ...
    filename = "Politecnico_di_Torino.txt"
    f = open(filename, "w")

    excel_filename = "Politecnico_di_Torino.csv"
    ...
    d = soup.find_all('td')
   # dd = d.find_all('', {'class': 'views-field views-field-title'})
    ...
    for i in d:
        ...
        if a!=None:
             ...
             link = "https://www.dauin.polito.it"+a.get('href')                # extracting prof page link
             name = a.get_text() 
             print(name, link)
                        # a contains the name and the homepage of prof
