...
def yeshiva():
    url = "https://www.yu.edu/faculty"   # homepage url
    ...
    filename = "yeshiva.txt"
    f = open(filename, "w")

    excel_filename = "yeshiva.csv"
    ...
    garbage_emails = ['publicaffairs@yu.edu','yuadmit@yu.edu']
    ...
    #d = d1.find_next('div', {'class' : 'views-row'})

    d = soup.find_all('div', {'class' : 'views-row'})
  ...
  #  dd = d.find_all('div', {'class': 'views-field views-field-title'})
    ...
    for i in d:
        ...
        #print(a)
        link = "https://www.yu.edu/"+ a.get('href')                # extracting prof page link
