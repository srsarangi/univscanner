...
def UCA():
    url = "https://uca.edu/cse/facultystaff/"   # homepage url
    ...
    d = dd.find_all('div', {'class':"fs_list"})
    # print(d)  
...
def filterandgetEmail(var, garbage_emails, name, link, email, prof_resp):
    ...
    keyword_list = ['Computer architecture','computer architecture','Computer Architecture', 'Hardware And System Architecture', 'hardware and system architecture', 
                ...
                'Distributed System', 'distributed system', 'Distributed system' ,'Real-time Simulation Design and Development','System Security','Security and privacy']
    flag = 1
