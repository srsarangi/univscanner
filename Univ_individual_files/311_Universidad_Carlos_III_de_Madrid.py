...
def Universidad_Carlos_III_de_Madridcsv():
    url = "https://www.uc3m.es/ss/Satellite/Doctorado/en/Detalle/Estudio_C/1422576090112/1371210298470/Computer_Science_and_Technology#faculty"   # homepage url
    ...
    filename = "Universidad_Carlos_III_de_Madrid.txt"
    f = open(filename, "w")

    excel_filename = "Universidad_Carlos_III_de_Madrid.csv"
...
if __name__ == '__main__':
    Universidad_Carlos_III_de_Madridcsv()
