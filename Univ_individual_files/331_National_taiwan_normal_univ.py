...
def National_taiwan_normal_university():
    url = "https://www.csie.ntnu.edu.tw/index.php/en/faculty_en/"   # homepage url
    ...
    d = soup.find('div', {'class':'entry clr'})
    dd = d.find_all('div', {'class':'elementor-image-box-content'})
    #print(dd)
    ...
    for i in dd:
        ...
        name = a.get_text() 
        email_1 = a.find_next('a').get('href')
       # print(email)
       # email =                 # extracting prof name
        #print(name, "\t", link)
        name = name.strip()
