...
def Friedrich_Alexander_Universität_Erlangen_Nürnberg():
    url = "https://www.cs3.tf.fau.de/"   # homepage url
    ...
    filename = "Friedrich_Alexander_Universität_Erlangen_Nürnberg.txt"
    f = open(filename, "w")

    excel_filename = "Friedrich_Alexander_Universität_Erlangen_Nürnberg.csv"
    ...
    u_name = "Friedrich_Alexander_Universität_Erlangen_Nürnberg"
    country = "UK"
    ...
    d = soup.find('aside', {'class':'startpage-sidebar'})
    dd = d.find_all('h2')
...
if __name__ == '__main__':
   Friedrich_Alexander_Universität_Erlangen_Nürnberg()