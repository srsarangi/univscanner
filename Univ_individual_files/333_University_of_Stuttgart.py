...
def Stuttgart():
    url = "https://www.iti.uni-stuttgart.de/en/institute/team/"   # homepage url
    ...
    filename = "stuttgart.txt"
    f = open(filename, "w")

    excel_filename = "stuttgart.csv"
    ...
    d = soup.find('div', {'class':'row flex-row generic-list'})
    dd = d.find_all('div', {'class': 'text'})
    ...
    for i in dd:
       # print(i)
        ...
        name = a.get_text() 
        email1 =   a.find_next('a',{"class":"Email"}).get('href')
        print(email1)

       # print(email1)          # extracting prof name
        #print(name, "\t", link)
        name = name.strip()
