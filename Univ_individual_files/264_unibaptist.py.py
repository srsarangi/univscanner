...
def baptist():
    ...
    filename = "hkbaptist.txt"
    f = open(filename, "w", encoding='utf-8')

    excel_filename = "hkbaptist.csv"
    ...
    d = soup.find_all('td',{'class':'ename'})
    ...
    for i in d:
        ...
        #print(a,z)
        name = i.find('a')
        link = 'https://www.comp.hkbu.edu.hk/v1'+name.get('href')           # extracting prof page link
        name = name.get_text()                                       # extracting prof name
        #print(a.find('a'))
        str1 = link
        str1 = str1.split('id=')
        #print(str1[1])
        email=str1[1]+'@comp.hkbu.edu.hk'
