...
def Miami():
    url = "https://csc.as.miami.edu/people/index.html"   # homepage url
    ...
    d = soup.find('div', {'class':'people-list list-view'})
    dd = d.find_all('div',{'class':'profile-simple-list hide-for-large-up hide-for-print'})
    ...
    for i in dd:
       ...
       # print(a) 
        ...
        if a!=None and type(a)!=int:                  # a contains the name and the homepage of prof
            link =  "https:"+a.get('href')[4:end] 
           # print(a.get('href'))               # extracting prof page link
...
if __name__ == '__main__':
    Miami()
    print("University of Miami:No Computer Architecture Professor found")