...
def iitmadras():
    ...
    filename = "iitmadras.txt"
    f = open(filename, "w", encoding='utf-8')

    excel_filename = "iitmadras.csv"
    ...
    for i in d:
        ...
        #print(link)
        try:
            prof_resp = requests.get('http://www.cse.iitm.ac.in/'+link1)      # requesting prof homepgae
        except:
            continue
