...
def unicanter():
    url = "https://www.canterbury.ac.nz/engineering/schools/csse/our-people/"
    ...
    filename = "canterbury.txt"
    f = open(filename, "w", encoding='utf-8')

    excel_filename = "canterbury.csv"
    ...
    d = soup.find_all('div', {'class':'col-xxs-7 col-xs-12 col-md-7'})
